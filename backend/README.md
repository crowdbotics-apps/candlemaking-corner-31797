...
## Project Structure
    ...
    ├── candlemaking_corner_31797  # Django project configurations
...
1. Clone this repo and `cd candlemaking_corner_31797`
...
2. Clone this repo and `cd candlemaking_corner_31797`
